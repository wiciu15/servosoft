...
typedef enum {no_error,undervoltage_condition,undervoltage,overvoltage,shortcircuit,inverter_overcurrent,motor_overcurrent,encoder_error_communication,encoder_error_mechanical,internal_software,external_comm}inverter_error_t;
...
extern float calculated_voltage_vector;
