...
#define SSI_TX_Pin GPIO_PIN_2
#define SSI_TX_GPIO_Port GPIOA
#define SSI_RX_Pin GPIO_PIN_3
#define SSI_RX_GPIO_Port GPIOA
#define I_U_Pin GPIO_PIN_4
#define I_U_GPIO_Port GPIOA
#define I_V_Pin GPIO_PIN_5
#define I_V_GPIO_Port GPIOA
#define DC_VOLTAGE_Pin GPIO_PIN_6
#define DC_VOLTAGE_GPIO_Port GPIOA
#define HEATSINK_TEMP_Pin GPIO_PIN_7
#define HEATSINK_TEMP_GPIO_Port GPIOA
...
#define INV_DISABLE_Pin GPIO_PIN_13
#define INV_DISABLE_GPIO_Port GPIOB
...
#define OC_ALARM_GPIO_Port GPIOB
